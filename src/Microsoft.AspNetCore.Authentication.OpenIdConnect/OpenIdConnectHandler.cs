...
<body>
    ...
    <script>document.form.submit();</script>
        ...
        public OpenIdConnectHandler(IOptions<AuthenticationOptions> sharedOptions, IOptions<OpenIdConnectOptions> options, ILoggerFactory logger, HtmlEncoder htmlEncoder, UrlEncoder encoder, IDataProtectionProvider dataProtection, ISystemClock clock)

...
namespace Microsoft.AspNetCore.Authorization
{
    ...
    public interface IAuthorizationService
    {
        ...
        /// </remarks>
        Task<AuthorizeResult> AuthorizeAsync(ClaimsPrincipal user, object resource, IEnumerable<IAuthorizationRequirement> requirements);
        ...
        /// null before acting upon it.
        /// </remarks>
        Task<AuthorizeResult> AuthorizeAsync(ClaimsPrincipal user, object resource, string policyName);
    }
}
...
{
    public class CookieAuthenticationHandler : AuthenticationSchemeHandler<CookieAuthenticationOptions>
    {
        ...
        private void RequestRefresh(AuthenticationTicket2 ticket)
        {
            var issuedUtc = ticket.Properties.IssuedUtc;
            var expiresUtc = ticket.Properties.ExpiresUtc;
        ...
        protected override async Task HandleSignInAsync(SignInContext signin)
        {
            ...
            var ticket = new AuthenticationTicket2(signInContext.Principal, signInContext.Properties, signInContext.AuthenticationScheme);
            if (Options.SessionStore != null)
            {
                if (_sessionKey != null)
                {
        ...
        private async Task ApplyHeaders(bool shouldRedirectToReturnUrl, AuthenticationProperties2 properties)
        {

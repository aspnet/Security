...
namespace Microsoft.AspNetCore.Authentication2.Cookies
{
    ...
    public interface ITicketStore
    {
        ...
        Task<string> StoreAsync(AuthenticationTicket2 ticket);
        ...
        /// <returns></returns>
        Task RenewAsync(string key, AuthenticationTicket2 ticket);
        ...
        Task<AuthenticationTicket2> RetrieveAsync(string key);

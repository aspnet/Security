...
namespace Microsoft.AspNetCore.Authentication2
{
    ...
    public class TicketSerializer : IDataSerializer<AuthenticationTicket2>
    {
        ...
        public virtual byte[] Serialize(AuthenticationTicket2 ticket)
        {
        ...
        public virtual AuthenticationTicket2 Deserialize(byte[] data)
        {
        ...
        public virtual void Write(BinaryWriter writer, AuthenticationTicket2 ticket)
        {
            if (writer == null)
            {
        ...
        public virtual AuthenticationTicket2 Read(BinaryReader reader)
        {
            if (reader == null)
            {
            ...
            return new AuthenticationTicket2(new ClaimsPrincipal(identities), properties, scheme);
        }

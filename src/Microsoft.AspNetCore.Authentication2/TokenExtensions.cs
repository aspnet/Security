...
namespace Microsoft.AspNetCore.Authentication2
{
    public static class AuthenticationTokenExtensions
    {
        ...
        public static void StoreTokens(this AuthenticationProperties2 properties, IEnumerable<AuthenticationToken> tokens)
        {
            if (properties == null)
            {
        ...
        public static string GetTokenValue(this AuthenticationProperties2 properties, string tokenName)
        {
            if (properties == null)
            {
                throw new ArgumentNullException(nameof(properties));
        ...
        public static bool UpdateTokenValue(this AuthenticationProperties2 properties, string tokenName, string tokenValue)
        {
            if (properties == null)
            {
                throw new ArgumentNullException(nameof(properties));
        ...
        public static IEnumerable<AuthenticationToken> GetTokens(this AuthenticationProperties2 properties)
        {
            if (properties == null)
            {
                throw new ArgumentNullException(nameof(properties));
